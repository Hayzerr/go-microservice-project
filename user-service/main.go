...
import (
	...
	grpcDelivery "github.com/Hayzerr/go-microservice-projectuser-service/internal/user/delivery/grpc" // Пакет для gRPC обработчиков
	...
	pb "github.com/Hayzerr/go-microservice-project/user-service/pb"                                    // Путь к сгенерированным .pb.go файлам
